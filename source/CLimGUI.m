classdef CLimGUI < handle
    ...
    methods
        function obj = CLimGUI(imageOrAxes, parent_figure, options)
            ...
            % Sized big enough that the glyph stays legible at the default
            % 175x100 px window - the previous 6%-of-figure height worked
            % out to ~6 px tall, which clipped the symbol.
            obj.ResetButton = uicontrol("Parent", obj.ParentFigure, ...
                ...
                "Units", "normalized", ...
                "Position", [0.000, 0.750, 0.150, 0.250], ...
