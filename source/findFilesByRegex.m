...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%           THIS FUNCTION IS DEPRECATED - USE findPaths INSTEAD
%
...
%
% This function is deprecated in favor of 'findPaths'. It may be removed in
...
%       {'1', '4', '7'}
%
% See also: dir, buildFileTree, findPaths
%
% Version: 1.0
% Author:  Brian Kardon
