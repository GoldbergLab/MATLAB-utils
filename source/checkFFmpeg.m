function [ffmpegExists, ffprobeExists, ffplayExists] = checkFFmpeg(checkFFmpeg, checkFFprobe, checkFFplay, issueWarning, issueError)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
arguments
    checkFFmpeg logical = true
    checkFFprobe logical = true
    checkFFplay logical = true
    issueWarning logical = true
    issueError logical = true
end
